...
const a1Str = fs.readFileSync(path.join(__dirname, 'kundli-a1.txt'), 'utf16le');
const a2Str = fs.readFileSync(path.join(__dirname, 'kundli-a2.txt'), 'utf16le');
...
fs.writeFileSync(
  path.join(__dirname, '../public/profiles/kundali.json'),
  JSON.stringify(profile, null, 2)
);

console.log("Successfully built public/profiles/kundali.json");
