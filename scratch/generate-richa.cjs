...
const a1Str = fs.readFileSync(path.join(__dirname, 'richa-a1.txt'), 'utf16le');
const a2Str = fs.readFileSync(path.join(__dirname, 'richa-a2.txt'), 'utf16le');
...
fs.writeFileSync(
  path.join(__dirname, '../public/profiles/richa.json'),
  JSON.stringify(profile, null, 2)
);

console.log("Successfully built public/profiles/richa.json");
